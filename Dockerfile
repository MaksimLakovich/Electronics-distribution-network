...
WORKDIR /electronics_distribution_network_project

# Копируем pyproject.toml и poetry.lock (чтобы зависимости кэшировались)
COPY pyproject.toml poetry.lock* /electronics_distribution_network_project/
...
COPY . /electronics_distribution_network_project
